...
| Metric | Value |
|---|---|
| Training data accuracy | 100% (2,856/2,856) |
| Unseen phrases (rules + lookup) | 95.5% (256/268) |
| Unseen phrases (with ML) | 95.5% (256/268) |
| ML-only accuracy (when invoked) | 91.4% (32/35) |
